/**
 * @typedef {'enhanced' | 'classic'} KeyAlgorithm
 */
...
/**
 * @typedef {Object} ColorKeyOptions
 * @property {ColorSample} sample
 * @property {number} tolerance
 * @property {number} softness
 * @property {number} despill
 * @property {number} sampleRadius
 * @property {number} edgeRadius
 * @property {boolean} smoothing
 * @property {boolean} despillEnabled
...
/**
 * @typedef {ExtractedFrame & { processedImage: HTMLCanvasElement, maskImage: HTMLCanvasElement }} ProcessedFrame
 */
 ...
 * @param {ColorKeyOptions} options
 * @returns {{ image: HTMLCanvasElement, mask: HTMLCanvasElement }}
 */
...
/**
 * @param {ExtractedFrame} frame
 * @param {ColorKeyOptions} options
 * @returns {ProcessedFrame}
 */
export function processExtractedFrame(frame, options) {
